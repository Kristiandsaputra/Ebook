...
import { Container, Header, Title, Content, Button, Body, Text } from 'native-base';
...
export default class ScoreQuizscreen extends Component {
  ...
  getParams = async () => {
    ...
    this.setState({ benar, jumlah: AllTrueAnswer.length });
      ...
      <Container>
        ...
        <Content>
          ...
          <Text style={styles.text2}>
            {this.state.benar} / {this.state.jumlah}
          </Text>
